...
func (s *MangaService) Details(ctx context.Context, mangaID int, options ...prm.DetailsOption) (*containers.Manga, *common.Response, error) {
...
func (s *MangaService) List(ctx context.Context, search string, options ...prm.OptionalParam) ([]containers.Manga, *common.Response, error) {
	options = append(options, common.OptionFromQuery(search))
	return s.list(ctx, "manga", options...)
}

func (s *MangaService) list(ctx context.Context, path string, options ...prm.OptionalParam) ([]containers.Manga, *common.Response, error) {
...
func (s *MangaService) DeleteMyListItem(ctx context.Context, mangaID int) (*common.Response, error) {
...
// certain ranking.
func (s *MangaService) Ranking(ctx context.Context, ranking prm.MangaRanking, options ...prm.OptionalParam) ([]containers.Manga, *common.Response, error) {
	options = append(
		options,
...
func (s *MangaService) UpdateMyListStatus(ctx context.Context, mangaID int, options ...prm.UpdateMyMangaListStatusOption) (*containers.MangaListStatus, *common.Response, error) {
