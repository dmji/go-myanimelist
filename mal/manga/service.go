...
func (s *Service) Details(ctx context.Context, mangaID int, options ...prm.DetailsOption) (*containers.Manga, *common.Response, error) {
...
func (s *Service) List(ctx context.Context, search string, options ...prm.OptionalParam) ([]containers.Manga, *common.Response, error) {
	options = append(options, common.OptionFromQuery(search))
	return s.list(ctx, "manga", options...)
}

func (s *Service) list(ctx context.Context, path string, options ...prm.OptionalParam) ([]containers.Manga, *common.Response, error) {
...
func (s *Service) DeleteMyListItem(ctx context.Context, mangaID int) (*common.Response, error) {
